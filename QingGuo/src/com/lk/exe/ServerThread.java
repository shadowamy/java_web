        ...
        try 
        {
        	...
        	while (true)
        	{
	            ...
	            else if(order.equals("what"))
	            {
	            	...
	            	String result = SocketImgResult.img_result();
	            	...
	            	if(result!=null&&!result.equals(""))
	            	{
		            	...
		            	//发送物体post
		            	Http_messageRequest.sendPost("http://localhost:8080/QingGuo/Qbject_nameRequest", "key="+result);
		            	//物体进入数据库
		            	try {
							ctr.insertOneByName(result);
							cal.handleInputName(result);
